...
export default function CorporateHubPage() {
    const projects = [
        {
            title: "Accounting Firm System",
            desc: "L'Expertise Augmentée. Conformité KYC, Bureau Zéro Papier et rentabilité dossier.",
            link: "/solutions/corporate/accounting-firm",
            image: "https://placehold.co/1920x1080/1B3C53/F5F5F0/png?text=Accounting+Preview"
        }
    ]
