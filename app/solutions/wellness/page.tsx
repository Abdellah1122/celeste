...
export default function WellnessHubPage() {
    const projects = [
        {
            title: "Hair Salon",
            desc: "L'Art du Style. Booking intelligent, gestion technique et portfolio intégré.",
            link: "/solutions/wellness/hair-salon",
            image: "https://placehold.co/1920x1080/EAEAEA/1B3C53/png?text=Salon+Preview"
        },
        {
            title: "Sports Club",
            desc: "Performance Communauté. Réservation terrains, gestion tournois et Pro Shop.",
            link: "/solutions/wellness/sports-club",
            image: "https://placehold.co/1920x1080/1B3C53/F5F5F0/png?text=Sports+Club+Preview"
        },
        {
            title: "Fitness Center",
            desc: "Santé Efficacité. Gestion des abonnements, planning des cours et maintenance.",
            link: "/solutions/wellness/fitness",
            image: "https://placehold.co/1920x1080/F5F5F0/1B3C53/png?text=Fitness+Preview"
        }
    ]
