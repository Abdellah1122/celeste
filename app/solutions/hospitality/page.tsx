...
export default function HospitalityHubPage() {
    const projects = [
        {
            title: "Système Hôtelier (HMS)",
            desc: "L'Architecture du Séjour Parfait. PMS centralisé, Booking Engine et Housekeeping.",
            link: "/solutions/hospitality/hms",
            image: "https://placehold.co/1920x1080/EAEAEA/1B3C53/png?text=HMS+Preview"
        },
        {
            title: "Gestion Restaurant",
            desc: "De la Cuisine à la Table. POS Tactile, KDS Cuisine et Menu Digital.",
            link: "/solutions/hospitality/restaurant",
            image: "https://placehold.co/1920x1080/1B3C53/F5F5F0/png?text=Restaurant+Preview"
        },
        {
            title: "Bars & Pubs",
            desc: "Vitesse et Mixologie. Gestion des fûts, doseurs et mobilité serveur.",
            link: "/solutions/hospitality/bars",
            image: "https://placehold.co/1920x1080/F5F5F0/1B3C53/png?text=Bar+Preview"
        },
        {
            title: "Distribution F&B",
            desc: "Logistique Agroalimentaire. Traçabilité des lots (FEFO) et flottes de livraison.",
            link: "/solutions/hospitality/food-distribution",
            image: "https://placehold.co/1920x1080/EAEAEA/1B3C53/png?text=Food+Dist+Preview"
        }
    ]
